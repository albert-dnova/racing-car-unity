...
public class Car : MonoBehaviour {
	...
	void Awake() 
	{
		...
		AxleFront = transform.Find ("FrontAxle").GetComponent<Axle>();
		AxleRear = transform.Find ("BackAxle").GetComponent<Axle>();
	...
	void Init() {
		...
		// Dimensions
		AxleFront.DistanceToCG = Mathf.Abs(CenterOfGravity.transform.position.y - AxleFront.transform.Find("TireLeft").transform.position.y);
		AxleRear.DistanceToCG = Mathf.Abs(CenterOfGravity.transform.position.y - AxleRear.transform.Find("TireLeft").transform.position.y);
